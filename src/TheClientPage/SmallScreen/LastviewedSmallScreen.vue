<template>
  <div class="SpicalShowRoom">
    <v-app-bar color="#eceff1" app flat>
      <v-btn text min-width="20" class="px-0" color="grey ">
        <v-icon color="#fc624d" size="26"> mdi-dots-vertical </v-icon>
      </v-btn>
      ...
      <v-spacer></v-spacer>
      <v-btn to="/TheUserPageView" color="grey darken-2" icon>
        <v-icon color="#757575" size="30"> mdi-arrow-left-thin </v-icon>
      </v-btn>
    </v-app-bar>
