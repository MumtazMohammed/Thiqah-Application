<template>
  <div class="UserAdd grey lighten-4">
    <v-app-bar flat class="white" app>
      ...
      <v-spacer></v-spacer>
      <v-btn to="/TheUserPageView" color="#fc624d" icon>
        <v-icon size="30">mdi-arrow-left-thin</v-icon>
      </v-btn>
    </v-app-bar>
    <v-sheet height="56"></v-sheet>
    <v-container class="pt-0">
      <v-tabs background-color="transparent" hide-slider v-model="tab" grow>
        <v-tab
          active-class="black--text font-weight-bold"
          class="text-all"
          href="#tab-1"
        >
          احصل على المزيد من القسائم
        </v-tab>
        <v-tab
          active-class="black--text font-weight-bold"
          class="text-all"
      ...
      <v-tabs-items touchless v-model="tab" class="transparent">
        <v-tab-item value="tab-1">
          ...
          <v-row no-gutters>
            <v-col class="pa-1" lg="4" md="4" cols="12" v-for="n in 3" :key="n">
              <v-sheet
                      ...
                      >
                        <v-col class="pa-1" cols="auto">
                          ...
                          <v-card-text class="pa-0 text">
                            أنفق
                            <span class="mx-1">
                              52<v-icon left size="17"
                                >mdi-currency-rial</v-icon
                              >
                            </span>
                            كحد أدنى
                          </v-card-text>
                        ...
                        <v-col cols="auto">
                          <v-btn tile small text class="btn">
                            أحصل عليها
                          </v-btn>
                        </v-col>
                      </v-row>
                ...
                <v-card flat color="#fff">
                  <v-row no-gutters align="center">
                    ...
                    <v-col cols="6">
                      <v-card-subtitle class="text pa-0">
                        خصم
                        <span class="mx-1 orange--text"><span>20</span>%</span>
                      </v-card-subtitle>
                      <v-card-text class="pa-0 text">
                        أنفق
                        <span class="mx-1">
                    ...
                    <v-spacer></v-spacer>
                    <v-col cols="auto">
                      <v-btn small text tile class="white btn">
                        أحصل عليها
                      </v-btn>
                    </v-col>
                  </v-row>
        ...
        <v-tab-item value="tab-2">
          ...
          >
            ...
            <v-tabs-items
              ...
              v-model="tabTow"
            >
              <v-tab-item class="transparent" value="tabTow-1">
                <v-row no-gutters>
                  <v-col
                    class="pa-2 py-1"
                    lg="4"
                  ...
                  >
                    <v-card flat color="#FAFAFA">
                      <v-row no-gutters align="center" class="main">
                        ...
                        <v-col cols="auto">
                          <v-btn tile small text class="white btn">
                            أستخدم
                          </v-btn>
                        </v-col>
                      </v-row>
              ...
              <v-tab-item class="transparent" value="tabTow-2">
                <v-row no-gutters>
                  <v-col
                    class="pa-2 py-1"
                    lg="4"
                    ...
                    :key="n"
                  >
                    <v-card disabled flat color="#FAFAFA">
                      <v-row no-gutters align="center" class="main">
                        <v-col cols="auto">
                          <v-img
                            contain
              ...
              <v-tab-item class="transparent" value="tabTow-3">
                <v-row no-gutters>
                  <v-col
                    class="pa-2 py-1"
                    lg="4"
